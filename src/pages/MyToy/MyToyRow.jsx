...
const MyToyRow = ({ myToy, handleDelete, handleEdit }) => {
    const { _id, picture, name, price, brand, quantity } = myToy;
            ...
            <td>
                <div className="flex text-center">
                    <div className="p-3 text-center">
                        <button className="btn btn-sm btn-circle btn-warning" data-tip="Delete" onMouseEnter={handleDeleteHover} onMouseLeave={handleDeleteHover} onClick={() => handleDelete(_id)}>
                    ...
                    <div className="p-3 text-center">
                        <button className="btn btn-sm btn-circle btn-warning" data-tip="Delete" onMouseEnter={handleDeleteHover} onMouseLeave={handleDeleteHover} onClick={() => handleEdit(_id)}>
